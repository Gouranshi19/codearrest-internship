...
function EditNote() {
    ...
    return (
        ...
        <div style={{ maxWidth: "500px", margin: "40px auto", background: "white", padding: "32px", borderRadius: "8px", border: "1px solid #ddd" }}>
            <h2 style={{ marginBottom: "24px" }}>Edit Note</h2>
            ...
            <textarea
                ...
                style={{ width: "100%", padding: "10px", marginBottom: "16px", borderRadius: "6px", border: "1px solid #ddd", boxSizing: "border-box" }}
            />
            <button type="submit" style={{ width: "100%", padding: "10px", background: "#0d6efd", color: "white", border: "none", borderRadius: "6px", fontSize: "16px", cursor: "pointer" }}>Update Note</button>
            </form>
        </div>
        </div>
    );
